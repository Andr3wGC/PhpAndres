...
-- DELIMITER $$
-- CREATE TRIGGER genidcat
-- BEFORE INSERT ON CATEGORIA
-- FOR EACH ROW
-- BEGIN
--   SET NEW.ID_CATEGORIA=CONCAT('C-',LPAD((SELECT LAST_INSERT_ID()+1),3,'0'));
-- END$$
-- DELIMITER ;

-- SHOW TABLE STATUS FROM CATEGORIA LIKE genidcat;

-- select CONCAT('C-',LPAD((SELECT LAST_INSERT_ID()+1),3,'0')) from CATEGORIA;
